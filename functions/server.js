...
const employeeSyncFunctions = require('./src/api/employeeSyncFunctions');
...
app.use(`${BASE}/holidays`, holidayFunctions);
app.use(`${BASE}/employees/sync`, requireAuthenticatedUser, employeeSyncFunctions);
